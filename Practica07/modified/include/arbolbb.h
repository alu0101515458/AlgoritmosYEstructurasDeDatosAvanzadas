...
bool ArbolBB<Key>::insertar(const Key& dat) { 
  ++comparaciones_; // Incrementamos el contador de comparaciones.
...
/**
 * @brief Método que obtiene el número de comparaciones realizadas
 */
template <class Key>
int ArbolBB<Key>::getComparaciones() const {
