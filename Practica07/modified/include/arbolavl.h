...
/**
 * @brief Función que devuelve el número de comparaciones realizadas
 * 
 * @tparam Key Dato a procesar
 * @return int Número de comparaciones realizadas
 */
template <class Key>
int ArbolAVL<Key>::getComparaciones() const { return comparaciones_; }